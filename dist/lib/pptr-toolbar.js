(function () {
	...
	const Toolbar = ({ config, testPath, testId, customToolbar }) => {
	  ...
	  return /* @__PURE__ */ jsxs("div", { id: "a-b-toolbar", class: `${modules_ed59282c$1.toolbar} ${open ? modules_ed59282c$1.open : modules_ed59282c$1.closed}`, ref, children: [
	    ...
	    /* @__PURE__ */ jsx("button", { class: modules_ed59282c$1.previewButton, onClick: () => window.takeScreenshot(fullscreen), children: "Take screenshot" }),
