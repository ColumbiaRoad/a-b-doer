!(function () {
	...
	function t(e, t) {
		...
		if (
			...
			for (var i = n.slice(0, n.lastIndexOf('/') + 1) + e, o = [], c = -1, s = 0; i.length > s; s++)
				-1 !== c
	...
	function f(t, n, r) {
		...
		return (i = t[w][n] =
			{ id: n, i: o, n: c, I: s, L: u, h: !1, d: void 0, e: void 0, er: void 0, E: void 0, C: void 0, p: void 0 });
	}
	function a() {
				...
				return new Promise(function (o, c) {
					r.addEventListener('error', function () {
						...
						r.addEventListener('load', function () {
							if ((document.head.removeChild(r), b === t)) c(T);
							else {
								var e = i.getRegister(t);
								e && e[0] === S && clearTimeout(P), o(e);
							}
						}),
